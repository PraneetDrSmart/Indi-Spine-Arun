...
function initMap() {
    const placeId = 'ChIJr9emV6WRyzsRAbv23VUvqMw';
...
script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyDDs7_h3OO_1MyDGNdQWWUuy-LQ1nRuN9M&libraries=places&callback=initMap`;
script.async = true;
script.defer = true;
